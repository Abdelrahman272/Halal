            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="discount_amount" type="number" step="0.01"
                        ...
                        value="{{ $coupon->discount_amount }}" required autocomplete="discount_amount">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="max_uses" type="number" step="0.01"
                        ...
                        value="{{$coupon->max_uses}}" required autocomplete="max_uses">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="start_date" type="datetime-local"
                        ...
                        value="{{ $coupon->start_date }}" required autocomplete="start_date">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="end_date" type="datetime-local"
                        ...
                        value="{{ $coupon->end_date }}" required autocomplete="end_date">
